...
export default function Footer() {
    return (
        <footer className="relative bg-transparent pt-4 px-3 md:px-5 pb-12">
            <div className="relative overflow-hidden rounded-[3rem] md:rounded-[4.5rem] bg-[#05087c] text-white py-24 px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                        ...
                        <div className="col-span-1 md:col-span-1">
                            ...
                            <p className="text-white/60 text-sm leading-relaxed max-w-xs pl-1 font-medium">
                    ...
                    <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center text-[10px] md:text-xs uppercase tracking-[0.2em] text-white/40">
                        ...
                        <div className="mt-6 md:mt-0 font-bold">
                            <span>Powered by <span className="text-white/80">Loom Rooms</span></span>
                        </div>
                    </div>
                </div>
            </div>
